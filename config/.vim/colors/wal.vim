...
exe 'hi clear CursorLine ctermbg=NONE guibg=NONE ctermfg=NONE guifg=NONE'
exe 'hi LineNr guibg=NONE ctermbg=NONE ctermfg=8 guifg='.g:color8
exe 'hi clear CursorLineNr guibg=NONE ctermbg=NONE ctermfg=NONE guifg=NONE'
...
exe 'hi clear Cursor guibg=NONE ctermbg=NONE ctermfg=8 guifg='.g:color8
