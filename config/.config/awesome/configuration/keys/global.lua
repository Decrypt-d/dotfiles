...
local global_keys = awful.util.table.join(
	...
	awful.key(
		...
		'Escape',
		function()
			awful.spawn(apps.default.terminal .. ' ' .. 'gtop')
		end,
	...
	awful.key(
		...
		'r',
		function()
	        local wall_dir = filesystem.get_xdg_config_home() .. (config.module.dynamic_wallpaper.wall_dir or 'wallpapers/')
            valid_picture_formats = config.module.dynamic_wallpaper.valid_picture_formats or {"jpg", "png", "jpeg"}
            local wallpapers = dir.filter_files_by_format(dir.get_dir_contents(wall_dir), valid_picture_formats)
            local wallpaper_path =  wall_dir .. wallpapers[math.random(#wallpapers)]
            if config.module.dynamic_wallpaper.stretch then
		        for s in screen do
            ...
            awful.spawn.with_shell('which wal && wal -i "' .. wallpaper_path .. '"')
		end,
		{description = 'change wallpaper', group = 'launcher'}
	),
    -- ##################################################
    -- Window/Client movement and manipulation
    -- ##################################################
    awful.key(
        {modkey},
        'h',
        ...
        {description = 'change window focus left', group = 'client'}
    ),
    awful.key(
        {modkey},
        'l',
        ...
        {description = 'change window focus right', group = 'client'}
    ),
    awful.key(
        {modkey},
        'k',
        ...
        {description = 'change window focus up', group = 'client'}
    ),
    awful.key(
        {modkey},
        'j',
        ...
        {description = 'change window focus down', group = 'client'}
    ),
    awful.key(
        {modkey, 'Shift'},
        'h',
        ...
        {description = 'move window focus left', group = 'client'}
    ),
    awful.key(
        {modkey, 'Shift'},
        'l',
        ...
        {description = 'move window focus right', group = 'client'}
    ),
    awful.key(
        {modkey, 'Shift'},
        'k',
        ...
        {description = 'move window focus up', group = 'client'}
    ),
    awful.key(
        {modkey, 'Shift'},
        'j',
        ...
        {description = 'move window focus down', group = 'client'}
    ),
    awful.key(
        {modkey},
        'c',
    ...
    awful.key(
        ...
        function()
            if client.focus then
                awesome.kill(client.focus.pid, 9)
            end
        end,
